...
//				new secondPage()
	...
	public void displayCustomers() throws SQLException {
		String query = "SELECT Name,Address, Phone, Type FROM customer";
		try (Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/hms", "root", "H@mayun123");
